...
//                            .build()
    ...
    public static final Supplier<AttachmentType<BucketSelectionConfig>> BUCKET_SELECTION_CONFIG = AttachmentRegistryHelper.registerWithOutSerialize(Painter.frame,"bucket_selection_config",()->new BucketSelectionConfig());
